...
returns_z <- returns_xts
returns_z[ , c("DTWEXAFEGS", "BAMLH0A0HYM2")] <- -returns_z[ , c("DTWEXAFEGS", "BAMLH0A0HYM2")]
```
...
returns_x[ , c("DTWEXAFEGS", "BAMLH0A0HYM2")] <- -returns_x[ , c("DTWEXAFEGS", "BAMLH0A0HYM2")]
```
