...
Install `Anaconda` on `Amazon Linux 2`
...
c.ServerApp.password = 'sha1:asdfasdf:asfasdfasdf'
# [ESC][:wq][ENTER]
```
...
sudo amazon-linux-extras install R1.2 # Amazon Linux 2
```
...
```
wget https://download2.rstudio.org/server/centos6/x86_64/rstudio-server-rhel-1.2.3-x86_64.rpm
yum install rstudio-server-rhel-1.2.3-x86_64.rpm
...
wget https://download3.rstudio.org/centos6.3/x86_64/shiny-server-1.2.3.456-x86_64.rpm
yum install --nogpgcheck shiny-server-1.2.3.456-x86_64.rpm
