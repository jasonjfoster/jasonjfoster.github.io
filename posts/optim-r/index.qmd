...
# library(rolloptim)
# 
# mu <- roll::roll_mean(returns_x_xts, 5)
# sigma <- roll::roll_cov(returns_x_xts, width = 5)
# 
# xx <- roll::roll_crossprod(returns_x_xts, returns_x_xts, 5)
# xy <- roll::roll_crossprod(returns_x_xts, y, 5) # TO DO
# 
# roll_max_mean(mu)
```
