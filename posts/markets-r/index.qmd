...
momentum_xts <- na.omit(lag(roll::roll_prod(1 + returns_xts, width - order, min_obs = 1) - 1, order))
```
...
```{r}
#| echo: false
#| warning: false # rows containing missing values or values outside the scale range
#| fig.width: 6
#| fig.height: 3
